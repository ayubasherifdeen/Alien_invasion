...
class AlienInvasion:
    ...
    def _check_events(self):
        """Repond to various keyboard and mouse events"""
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to bullet-alien collisoins"""
        #Check for any bullets that have hit, and get rid of bullet and alien
    ...
    def _create_fleet(self):
        ...
        #Spacing between each alien equals width of one alien
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond to aliens reaching the edges"""
